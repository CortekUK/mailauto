...
export async function middleware(request: NextRequest) {
  ...
  const isWebhookEndpoint = request.nextUrl.pathname.startsWith("/api/webhook")
  ...
  if (!user && !isAuthPage && !isSyncEndpoint && !isCronEndpoint && !isWebhookEndpoint && !isCampaignSendEndpoint) {
